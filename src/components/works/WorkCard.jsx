...
export const WorkCard = (work) => {
  return (
    <div className="border border-[rgba(_205,_210,_230,_0.21)] flex flex-row px-3 py-2 flex-1 justify-around items-center rounded-xl h-[200px]  bg-primary md:max-w-[62%] w-[90%]  gap-[20px]  shadow-[rgba(_205,_210,_230,_0.21)_0px_3px_8px] animate__animated animate__headShake  hover:scale-105 transform transition-transform">
