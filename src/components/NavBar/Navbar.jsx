  ...
  return (
    <div className="relative z-10">
      <ul className='flex p-2 w-full justify-evenly gap-[60px] bg-primary items-center rounded-xl shadow-[rgba(_205,_210,_230,_0.21)_0px_3px_8px]'>
        ...
        <div className='sm:max-w-[60%] sm:px-[25px] max-w-[30%] px-[10px] flex justify-center items-center'>
          <img className='sm:max-w-[70%] object-contain animate__animated animate__headShake  h-[85px]' src={logo} alt="" />
        </div>
